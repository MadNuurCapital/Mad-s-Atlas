...
-- =============================================================================
--
-- Without this, NOBODY can sign in, including you. Replace the address below
-- with your exact Google address, then run these two lines.
--
-- Gmail ignores dots and anything after a "+", so store the normalised form:
-- private.normalise_email does that for you.

-- insert into private.allowed_users (email, enabled)
-- values (private.normalise_email('you@gmail.com'), true)
